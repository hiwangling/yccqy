...
Source Database       : kybz

Target Server Type    : MYSQL
Target Server Version : 50553
File Encoding         : 65001

Date: 2018-04-04 09:11:02
*/
...
CREATE TABLE `ky_action_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1343 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='行为日志表';

-- ----------------------------
-- Records of ky_action_log
-- ----------------------------
INSERT INTO `ky_action_log` VALUES ('1311', '1', 'admin', '127.0.0.1', '登录', '登录操作，username：admin', '/admin/login/loginhandle.html', '1', '1521528200', '1521528200');
INSERT INTO `ky_action_log` VALUES ('1312', '1', 'admin', '127.0.0.1', '登录', '登录操作，username：admin', '/admin/login/loginhandle.html', '1', '1521765354', '1521765354');
INSERT INTO `ky_action_log` VALUES ('1313', '1', 'admin', '127.0.0.1', '登录', '登录操作，username：admin', '/admin/login/loginhandle.html', '1', '1521771160', '1521771160');
INSERT INTO `ky_action_log` VALUES ('1314', '1', 'admin', '127.0.0.1', '登录', '登录操作，username：admin', '/public/admin/login/loginhandle.html', '1', '1522484596', '1522484596');
INSERT INTO `ky_action_log` VALUES ('1315', '1', 'admin', '127.0.0.1', '登录', '登录操作，username：admin', '/public/admin/login/loginhandle.html', '1', '1522631008', '1522631008');
INSERT INTO `ky_action_log` VALUES ('1316', '1', 'admin', '127.0.0.1', '新增', '新增菜单，name：墓位管理', '/public/admin/menu/menuadd.html', '1', '1522634245', '1522634245');
INSERT INTO `ky_action_log` VALUES ('1317', '1', 'admin', '127.0.0.1', '数据排序', '数据排序调整，model：Menu，id：16，value：4', '/public/admin/menu/setsort.html', '1', '1522634265', '1522634265');
INSERT INTO `ky_action_log` VALUES ('1318', '1', 'admin', '127.0.0.1', '数据状态', '数据状态调整，model：Menu，ids：16，status：0', '/public/admin/menu/setstatus/ids/16/status/0.html', '1', '1522634266', '1522634266');
INSERT INTO `ky_action_log` VALUES ('1319', '1', 'admin', '127.0.0.1', '数据状态', '数据状态调整，model：Menu，ids：16，status：1', '/public/admin/menu/setstatus/ids/16/status/1.html', '1', '1522634270', '1522634270');
INSERT INTO `ky_action_log` VALUES ('1320', '1', 'admin', '127.0.0.1', '新增', '新增菜单，name：墓位类型', '/public/admin/menu/menuadd.html', '1', '1522634588', '1522634588');
INSERT INTO `ky_action_log` VALUES ('1321', '1', 'admin', '127.0.0.1', '新增', '新增菜单，name：123', '/public/admin/menu/menuadd.html', '1', '1522634622', '1522634622');
INSERT INTO `ky_action_log` VALUES ('1322', '1', 'admin', '127.0.0.1', '数据状态', '数据状态调整，model：Menu，ids：211，status：-1', '/public/admin/menu/setstatus/ids/211/status/-1.html', '1', '1522634629', '1522634629');
INSERT INTO `ky_action_log` VALUES ('1323', '1', 'admin', '127.0.0.1', '登录', '登录操作，username：admin', '/public/admin/login/loginhandle.html', '1', '1522716809', '1522716809');
INSERT INTO `ky_action_log` VALUES ('1324', '1', 'admin', '127.0.0.1', '编辑', '编辑菜单，name：墓位类型', '/public/admin/menu/menuedit.html', '1', '1522717556', '1522717556');
INSERT INTO `ky_action_log` VALUES ('1325', '1', 'admin', '127.0.0.1', '编辑', '编辑菜单，name：墓位类型', '/public/admin/menu/menuedit.html', '1', '1522718870', '1522718870');
INSERT INTO `ky_action_log` VALUES ('1326', '1', 'admin', '127.0.0.1', '编辑', '编辑菜单，name：墓位类型', '/public/admin/menu/menuedit.html', '1', '1522718899', '1522718899');
INSERT INTO `ky_action_log` VALUES ('1327', '1', 'admin', '127.0.0.1', '编辑', '编辑菜单，name：墓位类型', '/public/admin/menu/menuedit.html', '1', '1522741407', '1522741407');
INSERT INTO `ky_action_log` VALUES ('1328', '1', 'admin', '127.0.0.1', '数据状态', '数据状态调整，model：Article，ids：40，status：0', '/public/admin/article/setstatus/ids/40/status/0.html', '1', '1522744618', '1522744618');
INSERT INTO `ky_action_log` VALUES ('1329', '1', 'admin', '127.0.0.1', '数据状态', '数据状态调整，model：Article，ids：40，status：1', '/public/admin/article/setstatus/ids/40/status/1.html', '1', '1522744636', '1522744636');
INSERT INTO `ky_action_log` VALUES ('1330', '1', 'admin', '127.0.0.1', '新增', '新增墓位类型，name：123', '/public/admin/cemetery_type/cemeterytypeadd.html', '1', '1522746495', '1522746495');
INSERT INTO `ky_action_log` VALUES ('1331', '1', 'admin', '127.0.0.1', '新增', '新增墓位类型，name：111', '/public/admin/cemetery_type/cemeterytypeadd.html', '1', '1522747007', '1522747007');
INSERT INTO `ky_action_log` VALUES ('1332', '1', 'admin', '127.0.0.1', '新增', '新增墓位类型，name：1', '/public/admin/cemetery_type/cemeterytypeadd.html', '1', '1522747101', '1522747101');
INSERT INTO `ky_action_log` VALUES ('1333', '1', 'admin', '127.0.0.1', '编辑', '编辑墓位类型，name：123', '/public/admin/cemetery_type/cemeterytypeedit.html', '1', '1522747936', '1522747936');
INSERT INTO `ky_action_log` VALUES ('1334', '1', 'admin', '127.0.0.1', '删除', '墓位类型删除，where：id=2', '/public/admin/cemetery_type/cemeterytypedel/id/2.html', '1', '1522748044', '1522748044');
INSERT INTO `ky_action_log` VALUES ('1335', '1', 'admin', '127.0.0.1', '新增', '新增菜单，name：部门管理', '/public/admin/menu/menuadd.html', '1', '1522802690', '1522802690');
INSERT INTO `ky_action_log` VALUES ('1336', '1', 'admin', '127.0.0.1', '新增', '新增部门，name：技术部', '/public/admin/branch/branchadd.html', '1', '1522803434', '1522803434');
INSERT INTO `ky_action_log` VALUES ('1337', '1', 'admin', '127.0.0.1', '编辑', '编辑部门，name：技术部1', '/public/admin/branch/branchedit.html', '1', '1522803639', '1522803639');
INSERT INTO `ky_action_log` VALUES ('1338', '1', 'admin', '127.0.0.1', '新增', '新增部门，name：123', '/public/admin/branch/branchadd.html', '1', '1522803645', '1522803645');
INSERT INTO `ky_action_log` VALUES ('1339', '1', 'admin', '127.0.0.1', '删除', '部门删除，where：id=2', '/public/admin/branch/branchdel/id/2.html', '1', '1522803648', '1522803648');
INSERT INTO `ky_action_log` VALUES ('1340', '1', 'admin', '127.0.0.1', '编辑', '编辑部门，name：技术部', '/public/admin/branch/branchedit.html', '1', '1522803651', '1522803651');
INSERT INTO `ky_action_log` VALUES ('1341', '1', 'admin', '127.0.0.1', '新增', '新增部门，name：销售部', '/public/admin/branch/branchadd.html', '1', '1522803658', '1522803658');
INSERT INTO `ky_action_log` VALUES ('1342', '1', 'admin', '127.0.0.1', '新增', '新增墓位类型，name：两人墓', '/public/admin/cemetery_type/cemeterytypeadd.html', '1', '1522803993', '1522803993');
...
-- ----------------------------
INSERT INTO `ky_branch` VALUES ('1', '技术部', '1', '1522803434', '1522803651');
INSERT INTO `ky_branch` VALUES ('2', '123', '-1', '1522803645', '1522803648');
INSERT INTO `ky_branch` VALUES ('3', '销售部', '1', '1522803658', '1522803658');
...
-- ----------------------------
INSERT INTO `ky_cemetery_type` VALUES ('1', '123', '2', '1', '1522746495', '1522747936');
INSERT INTO `ky_cemetery_type` VALUES ('2', '111', '0', '-1', '1522747007', '1522748044');
INSERT INTO `ky_cemetery_type` VALUES ('3', '1', '12', '1', '1522747101', '1522747101');
INSERT INTO `ky_cemetery_type` VALUES ('4', '两人墓', '2', '1', '1522803993', '1522803993');
...
-- ----------------------------
INSERT INTO `ky_config` VALUES ('1', 'seo_title', '1', '网站标题', '1', '', '网站标题前台显示标题，优先级低于SEO模块', '1378898976', '1512555314', '1', 'OneBase免费开源架构', '3');
INSERT INTO `ky_config` VALUES ('2', 'seo_description', '2', '网站描述', '1', '', '网站搜索引擎描述，优先级低于SEO模块', '1378898976', '1512555314', '1', 'OneBase|ThinkPHP5', '100');
INSERT INTO `ky_config` VALUES ('3', 'seo_keywords', '2', '网站关键字', '1', '', '网站搜索引擎关键字，优先级低于SEO模块', '1378898976', '1512555314', '1', 'OneBase|ThinkPHP5', '99');
...
INSERT INTO `ky_config` VALUES ('33', 'allow_url', '3', '不受权限验证的url', '3', '', '', '1386644047', '1512982406', '1', '0:file/pictureupload\r\n1:addon/execute', '100');
...
INSERT INTO `ky_config` VALUES ('49', 'static_domain', '1', '静态资源域名', '1', '', '若静态资源为本地资源则此项为空，若为外部资源则为存放静态资源的域名', '1502430387', '1512555314', '1', '', '0');
...
INSERT INTO `ky_config` VALUES ('55', 'frontend_theme', '1', '前端主题', '1', '', '', '1504762360', '1512555314', '1', 'default', '0');
...
-- ----------------------------
INSERT INTO `ky_member` VALUES ('1', 'admin', 'admin', '8d83464ef9d3f420759ef33ddb1258c0', 'yczhj2007@126.com', '18555550710', '1522716808', '1521528175', '1', '0', '0', '1');
...
-- Records of ky_menu
-- ----------------------------
INSERT INTO `ky_menu` VALUES ('1', '系统首页', '0', '1', 'admin', 'index/index', '0', 'fa-home', '1', '1520506753', '0');
INSERT INTO `ky_menu` VALUES ('16', '会员管理', '0', '4', 'admin', 'member/index', '0', 'fa-users', '1', '1522634270', '0');
INSERT INTO `ky_menu` VALUES ('17', '会员列表', '16', '1', 'admin', 'member/memberlist', '0', 'fa-list', '1', '1495272875', '0');
INSERT INTO `ky_menu` VALUES ('18', '会员添加', '16', '2', 'admin', 'member/memberadd', '0', 'fa-user-plus', '1', '1520505510', '0');
INSERT INTO `ky_menu` VALUES ('27', '权限管理', '16', '3', 'admin', 'auth/grouplist', '0', 'fa-key', '1', '1520505512', '0');
INSERT INTO `ky_menu` VALUES ('32', '权限组编辑', '27', '0', 'admin', 'auth/groupedit', '1', '', '1', '1492002620', '0');
INSERT INTO `ky_menu` VALUES ('34', '授权', '27', '0', 'admin', 'auth_manager/group', '1', '', '1', '0', '0');
INSERT INTO `ky_menu` VALUES ('35', '菜单授权', '27', '0', 'admin', 'auth/menuauth', '1', '', '1', '1492095653', '0');
INSERT INTO `ky_menu` VALUES ('36', '会员授权', '27', '0', 'admin', 'auth_manager/memberaccess', '1', '', '1', '0', '0');
INSERT INTO `ky_menu` VALUES ('68', '系统管理', '0', '2', 'admin', 'config/group', '0', 'fa-wrench', '1', '1520506753', '0');
INSERT INTO `ky_menu` VALUES ('69', '系统设置', '68', '3', 'admin', 'config/setting', '0', 'fa-cogs', '1', '1520505460', '0');
INSERT INTO `ky_menu` VALUES ('70', '配置管理', '68', '2', 'admin', 'config/index', '0', 'fa-cog', '1', '1520505457', '0');
INSERT INTO `ky_menu` VALUES ('71', '配置编辑', '70', '0', 'admin', 'config/configedit', '1', '', '1', '1491674180', '0');
INSERT INTO `ky_menu` VALUES ('72', '配置删除', '70', '0', 'admin', 'config/configDel', '1', '', '1', '1491674201', '0');
INSERT INTO `ky_menu` VALUES ('73', '配置添加', '70', '0', 'admin', 'config/configadd', '0', 'fa-plus', '1', '1491666947', '0');
INSERT INTO `ky_menu` VALUES ('75', '菜单管理', '68', '1', 'admin', 'menu/index', '0', 'fa-th-large', '1', '1520505453', '0');
INSERT INTO `ky_menu` VALUES ('98', '菜单编辑', '75', '0', 'admin', 'menu/menuedit', '1', '', '1', '1512459021', '0');
INSERT INTO `ky_menu` VALUES ('108', '修改密码', '17', '0', 'admin', 'user/update_password', '1', '', '1', '0', '0');
INSERT INTO `ky_menu` VALUES ('109', '修改昵称', '17', '0', 'admin', 'user/update_nickname', '1', '', '1', '1491578211', '0');
INSERT INTO `ky_menu` VALUES ('124', '菜单列表', '75', '0', 'admin', 'menu/menulist', '0', 'fa-list', '1', '1491318271', '0');
INSERT INTO `ky_menu` VALUES ('125', '菜单添加', '75', '0', 'admin', 'menu/menuadd', '0', 'fa-plus', '1', '1491318307', '0');
INSERT INTO `ky_menu` VALUES ('126', '配置列表', '70', '0', 'admin', 'config/configlist', '0', 'fa-list', '1', '1491666890', '1491666890');
INSERT INTO `ky_menu` VALUES ('127', '菜单状态', '75', '0', 'admin', 'menu/setstatus', '1', '', '1', '1520506673', '1491674128');
INSERT INTO `ky_menu` VALUES ('128', '权限组添加', '27', '0', 'admin', 'auth/groupadd', '1', '', '1', '1492002635', '1492002635');
INSERT INTO `ky_menu` VALUES ('134', '授权', '17', '0', 'admin', 'member/memberauth', '1', '', '1', '1492238568', '1492101426');
INSERT INTO `ky_menu` VALUES ('135', '回收站', '68', '4', 'admin', 'trash/trashlist', '0', ' fa-recycle', '1', '1520505468', '1492311462');
INSERT INTO `ky_menu` VALUES ('136', '回收站数据', '135', '0', 'admin', 'trash/trashdatalist', '1', 'fa-database', '1', '1492319477', '1492319392');
INSERT INTO `ky_menu` VALUES ('140', '服务管理', '68', '5', 'admin', 'service/servicelist', '0', 'fa-server', '1', '1520505473', '1492352972');
INSERT INTO `ky_menu` VALUES ('141', '插件管理', '68', '6', 'admin', 'addon/index', '0', 'fa-puzzle-piece', '1', '1520505475', '1492427605');
INSERT INTO `ky_menu` VALUES ('142', '钩子列表', '141', '0', 'admin', 'addon/hooklist', '0', 'fa-anchor', '1', '1492427665', '1492427665');
INSERT INTO `ky_menu` VALUES ('143', '插件列表', '141', '0', 'admin', 'addon/addonlist', '0', 'fa-list', '1', '1492428116', '1492427838');
INSERT INTO `ky_menu` VALUES ('144', '文章管理', '0', '4', 'admin', 'article/index', '0', 'fa-edit', '1', '1520506753', '1492480187');
INSERT INTO `ky_menu` VALUES ('145', '文章列表', '144', '0', 'admin', 'article/articlelist', '0', 'fa-list', '1', '1492480245', '1492480245');
INSERT INTO `ky_menu` VALUES ('146', '文章分类', '144', '0', 'admin', 'article/articlecategorylist', '0', 'fa-list', '1', '1492480359', '1492480342');
INSERT INTO `ky_menu` VALUES ('147', '文章分类编辑', '146', '0', 'admin', 'article/articlecategoryedit', '1', '', '1', '1492485294', '1492485294');
INSERT INTO `ky_menu` VALUES ('148', '分类添加', '144', '0', 'admin', 'article/articlecategoryadd', '0', 'fa-plus', '1', '1492486590', '1492486576');
INSERT INTO `ky_menu` VALUES ('149', '文章添加', '144', '0', 'admin', 'article/articleadd', '0', 'fa-plus', '1', '1492518453', '1492518453');
INSERT INTO `ky_menu` VALUES ('150', '文章编辑', '145', '0', 'admin', 'article/articleedit', '1', '', '1', '1492879589', '1492879589');
INSERT INTO `ky_menu` VALUES ('151', '插件安装', '143', '0', 'admin', 'addon/addoninstall', '1', '', '1', '1492879763', '1492879763');
INSERT INTO `ky_menu` VALUES ('152', '插件卸载', '143', '0', 'admin', 'addon/addonuninstall', '1', '', '1', '1492879789', '1492879789');
INSERT INTO `ky_menu` VALUES ('153', '文章删除', '145', '0', 'admin', 'article/articledel', '1', '', '1', '1492879960', '1492879960');
INSERT INTO `ky_menu` VALUES ('154', '文章分类删除', '146', '0', 'admin', 'article/articlecategorydel', '1', '', '1', '1492879995', '1492879995');
INSERT INTO `ky_menu` VALUES ('156', '驱动安装', '140', '0', 'admin', 'service/driverinstall', '1', '', '1', '1502267009', '1502267009');
INSERT INTO `ky_menu` VALUES ('157', '接口管理', '0', '5', 'admin', 'api/index', '0', 'fa fa-book', '1', '1520506753', '1504000434');
INSERT INTO `ky_menu` VALUES ('158', '分组管理', '157', '0', 'admin', 'api/apigrouplist', '0', 'fa fa-fw fa-th-list', '1', '1504000977', '1504000723');
INSERT INTO `ky_menu` VALUES ('159', '分组添加', '157', '0', 'admin', 'api/apigroupadd', '0', 'fa fa-fw fa-plus', '1', '1504004646', '1504004646');
INSERT INTO `ky_menu` VALUES ('160', '分组编辑', '157', '0', 'admin', 'api/apigroupedit', '1', '', '1', '1504004710', '1504004710');
INSERT INTO `ky_menu` VALUES ('161', '分组删除', '157', '0', 'admin', 'api/apigroupdel', '1', '', '1', '1504004732', '1504004732');
INSERT INTO `ky_menu` VALUES ('162', '接口列表', '157', '0', 'admin', 'api/apilist', '0', 'fa fa-fw fa-th-list', '1', '1504172326', '1504172326');
INSERT INTO `ky_menu` VALUES ('163', '接口添加', '157', '0', 'admin', 'api/apiadd', '0', 'fa fa-fw fa-plus', '1', '1504172352', '1504172352');
INSERT INTO `ky_menu` VALUES ('164', '接口编辑', '157', '0', 'admin', 'api/apiedit', '1', '', '1', '1504172414', '1504172414');
INSERT INTO `ky_menu` VALUES ('165', '接口删除', '157', '0', 'admin', 'api/apidel', '1', '', '1', '1504172435', '1504172435');
INSERT INTO `ky_menu` VALUES ('166', '优化维护', '0', '6', 'admin', 'maintain/index', '0', 'fa-legal', '1', '1520506753', '1505387256');
INSERT INTO `ky_menu` VALUES ('167', 'SEO管理', '166', '0', 'admin', 'seo/seolist', '0', 'fa-list', '1', '1506309608', '1505387303');
INSERT INTO `ky_menu` VALUES ('168', '数据库', '166', '0', 'admin', 'maintain/database', '0', 'fa-database', '1', '1505539670', '1505539394');
INSERT INTO `ky_menu` VALUES ('169', '数据备份', '168', '0', 'admin', 'database/databackup', '0', 'fa-download', '1', '1506309900', '1505539428');
INSERT INTO `ky_menu` VALUES ('170', '数据还原', '168', '0', 'admin', 'database/datarestore', '0', 'fa-exchange', '1', '1506309911', '1505539492');
INSERT INTO `ky_menu` VALUES ('171', '文件清理', '166', '0', 'admin', 'fileclean/cleanlist', '0', 'fa-file', '1', '1506310152', '1505788517');
INSERT INTO `ky_menu` VALUES ('174', '行为日志', '166', '0', 'admin', 'log/loglist', '0', 'fa-street-view', '1', '1507201516', '1507200836');
INSERT INTO `ky_menu` VALUES ('176', '执行记录', '166', '0', 'admin', 'exelog/index', '0', 'fa-list-alt', '1', '1509433351', '1509433351');
INSERT INTO `ky_menu` VALUES ('177', '全局范围', '176', '0', 'admin', 'exelog/applist', '0', 'fa-tags', '1', '1509433570', '1509433570');
INSERT INTO `ky_menu` VALUES ('178', '接口范围', '176', '0', 'admin', 'exelog/apilist', '0', 'fa-tag', '1', '1509433591', '1509433591');
INSERT INTO `ky_menu` VALUES ('198', '统计分析', '0', '7', 'admin', 'statistic/index', '0', 'fa-connectdevelop', '1', '1520506758', '1512638014');
INSERT INTO `ky_menu` VALUES ('199', '权限等级', '198', '0', 'admin', 'statistic/membertree', '0', 'fa-users', '1', '1512638868', '1512638868');
INSERT INTO `ky_menu` VALUES ('200', '浏览器统计', '198', '0', 'admin', 'statistic/performerfacility', '0', 'fa-edge', '1', '1512727672', '1512727672');
INSERT INTO `ky_menu` VALUES ('201', '执行速度', '198', '0', 'admin', 'statistic/exespeed', '0', 'fa-fighter-jet', '1', '1512787226', '1512787226');
INSERT INTO `ky_menu` VALUES ('202', '会员增长', '198', '0', 'admin', 'statistic/membergrowth', '0', 'fa-line-chart', '1', '1512801997', '1512801997');
INSERT INTO `ky_menu` VALUES ('203', '友情链接', '68', '7', 'admin', 'blogroll/index', '0', 'fa-link', '1', '1520505723', '1520505717');
INSERT INTO `ky_menu` VALUES ('204', '链接列表', '203', '0', 'admin', 'blogroll/blogrolllist', '0', 'fa-th', '1', '1520505777', '1520505777');
INSERT INTO `ky_menu` VALUES ('205', '链接添加', '203', '0', 'admin', 'blogroll/blogrolladd', '0', 'fa-plus', '1', '1520505826', '1520505826');
INSERT INTO `ky_menu` VALUES ('206', '链接编辑', '203', '0', 'admin', 'blogroll/blogrolledit', '1', 'fa-edit', '1', '1520505863', '1520505863');
INSERT INTO `ky_menu` VALUES ('207', '链接删除', '203', '0', 'admin', 'blogroll/blogrolldel', '1', 'fa-minus', '1', '1520505889', '1520505889');
INSERT INTO `ky_menu` VALUES ('208', '菜单排序', '75', '0', 'admin', 'menu/setsort', '1', '', '1', '1520506696', '1520506696');
INSERT INTO `ky_menu` VALUES ('209', '墓位管理', '0', '3', 'admin', 'cemetery/index', '0', 'fa-institution', '1', '1522634244', '1522634244');
INSERT INTO `ky_menu` VALUES ('210', '墓位类型', '209', '0', 'admin', 'cemeteryType/cemeteryTypelist', '0', 'fa-twitter-square', '1', '1522741407', '1522634588');
INSERT INTO `ky_menu` VALUES ('211', '123', '209', '0', 'admin', '123', '0', '', '-1', '1522634629', '1522634622');
INSERT INTO `ky_menu` VALUES ('212', '部门管理', '209', '1', 'admin', 'branch/branchlist', '0', 'fa-flag', '1', '1522802690', '1522802690');
...
-- Records of ky_seo
-- ----------------------------
INSERT INTO `ky_seo` VALUES ('40', '首页SEO信息', 'index/index/index', 'OneBase 开发架构{$category_name}{$article_title}', 'OneBase,PHP,{$category_name},{$article_title}', '一款基于ThinkPHP5研发的开源免费基础架构，基于OneBase可以快速的研发各类Web应用。{$article_describe}', '{$category_name}，{$article_title}，{$article_describe}', '0', '1', '1505445912', '1505470293');
INSERT INTO `ky_seo` VALUES ('41', 'OneBase-系统登录', 'index/index/login', 'OneBase', 'OneBase', 'OneBase', '', '0', '1', '1505538002', '1505538026');
